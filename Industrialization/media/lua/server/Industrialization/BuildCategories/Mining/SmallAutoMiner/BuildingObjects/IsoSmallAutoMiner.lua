...
function IsoSmallAutoMiner.addMetalWeldingXpCustom(ISItem, xp)
...
function IsoSmallAutoMiner:create(x, y, z, north, sprite)
	...
	IsoSmallAutoMiner.addMetalWeldingXpCustom(self, 12);
...
function IsoSmallAutoMiner:new(player, sprite)
	...
	o.name = IsoSmallAutoMiner.FULL_NAME;
    o.thumpDmg = 0.1;
	o.player = player;
    
    --o.storageMax = IsoSmallAutoMiner.STORAGE_MAX; -- DEPRECATED: (NOTE: Set the container's max storage in a tileset def instead.)
