...
SRefiningGlobalObject = SIndustrializationGlobalObject:derive("SRefiningGlobalObject")

function SRefiningGlobalObject:new(luaSystem, globalObject)
...
function SRefiningGlobalObject:changeSprite()
