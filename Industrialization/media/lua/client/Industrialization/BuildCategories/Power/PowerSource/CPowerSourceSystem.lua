...
CPowerSourceSystem = CGlobalObjectSystem:derive("CPowerSourceSystem")

function CPowerSourceSystem:new()
	local o = CGlobalObjectSystem.new(self, "PowerSourceSystem")
	return o
end
...
CGlobalObjectSystem.RegisterSystemClass(CPowerSourceSystem)
