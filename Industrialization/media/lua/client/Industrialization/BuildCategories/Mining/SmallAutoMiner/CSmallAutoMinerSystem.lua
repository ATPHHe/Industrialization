...
CSmallAutoMinerSystem = CGlobalObjectSystem:derive("CSmallAutoMinerSystem")

function CSmallAutoMinerSystem:new()
	local o = CGlobalObjectSystem.new(self, "SmallAutoMinerSystem")
	return o
end

function CSmallAutoMinerSystem:isValidIsoObject(isoObject)
	return instanceof(isoObject, "IsoThumpable") and isoObject:getName() == IsoSmallAutoMiner.FULL_NAME
end

function CSmallAutoMinerSystem:newLuaObject(isoObject)
	return CSmallAutoMinerGlobalObject:new(self, isoObject)
end

CGlobalObjectSystem.RegisterSystemClass(CSmallAutoMinerSystem)
...
local function DoSpecialTooltip(tooltipUI, square)
	...
	--[[local barrel = CSmallAutoMinerSystem.instance:getIsoObjectOnSquare(square)
