...
function CIndustrializationGlobalObject:noise(message)
...
function CIndustrializationGlobalObject:getIsoObject()
	return self.luaSystem:getIsoObjectAt(self.x, self.y, self.z)
end

function CIndustrializationGlobalObject:getSquare()
	return getCell():getGrUIDSquare(self.x, self.y, self.z)
end

function CIndustrializationGlobalObject:fromModData(modData)
...
function CIndustrializationGlobalObject:updateFromIsoObject()
